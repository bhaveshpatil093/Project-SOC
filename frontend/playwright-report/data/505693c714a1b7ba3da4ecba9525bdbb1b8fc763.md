...
- Name: visual.spec.js >> Visual Regression >> alert detail visual snapshot
- Location: tests/e2e/visual.spec.js:11:3

# Error details

```
Error: A snapshot doesn't exist at /Users/bhaveshpatil/Developer/Project-SOC/Project-SOC/frontend/tests/e2e/visual.spec.js-snapshots/alert-detail-mobile-safari-darwin.png, writing actual.
```
