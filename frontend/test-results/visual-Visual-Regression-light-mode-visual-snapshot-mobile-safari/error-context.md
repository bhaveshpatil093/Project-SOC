...
```
Error: A snapshot doesn't exist at /Users/bhaveshpatil/Developer/Project-SOC/Project-SOC/frontend/tests/e2e/visual.spec.js-snapshots/dashboard-light-mobile-safari-darwin.png, writing actual.
```
