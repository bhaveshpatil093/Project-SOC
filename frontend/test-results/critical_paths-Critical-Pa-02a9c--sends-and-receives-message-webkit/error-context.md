...
- Name: critical_paths.spec.js >> Critical Paths >> SLM chat sends and receives message
- Location: tests/e2e/critical_paths.spec.js:40:3
...
Locator: getByPlaceholder('Ask SLM...')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByPlaceholder('Ask SLM...')
