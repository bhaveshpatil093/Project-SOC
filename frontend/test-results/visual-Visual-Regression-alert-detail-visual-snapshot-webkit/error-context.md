...
```
Error: A snapshot doesn't exist at /Users/bhaveshpatil/Developer/Project-SOC/Project-SOC/frontend/tests/e2e/visual.spec.js-snapshots/alert-detail-webkit-darwin.png, writing actual.
```
