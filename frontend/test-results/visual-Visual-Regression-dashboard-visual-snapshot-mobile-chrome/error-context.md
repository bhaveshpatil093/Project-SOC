...
- Name: visual.spec.js >> Visual Regression >> dashboard visual snapshot
- Location: tests/e2e/visual.spec.js:4:3

# Error details

```
Error: A snapshot doesn't exist at /Users/bhaveshpatil/Developer/Project-SOC/Project-SOC/frontend/tests/e2e/visual.spec.js-snapshots/dashboard-mobile-chrome-darwin.png, writing actual.
```
