...
- Name: visual.spec.js >> Visual Regression >> light mode visual snapshot
- Location: tests/e2e/visual.spec.js:27:3

# Error details

```
Error: A snapshot doesn't exist at /Users/bhaveshpatil/Developer/Project-SOC/Project-SOC/frontend/tests/e2e/visual.spec.js-snapshots/dashboard-light-mobile-chrome-darwin.png, writing actual.
```
