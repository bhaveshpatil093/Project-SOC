    ...
    <div 
      ...
      className={`p-4 rounded-xl border transition-all cursor-pointer ${
        isSelected 
          ...
          : 'border-[var(--border)] bg-[var(--bg-secondary)] hover:border-blue-400/50 hover:bg-[var(--bg-tertiary)]'
      }`}
    >
      <div className="flex items-center justify-between mb-3">
        ...
        <span className="text-xs font-mono px-2 py-1 rounded bg-[var(--bg-primary)] text-[var(--text-secondary)]">
          {team.team_id}
        </span>
      </div>
    ...
    <div className="space-y-6">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-[var(--bg-secondary)] p-4 rounded-xl border border-[var(--border)]">
          ...
          <div className="text-3xl font-bold">{stats?.avg_response_time || 0} <span className="text-lg text-[var(--text-secondary)] font-normal">min</span></div>
        </div>
        <div className="bg-[var(--bg-secondary)] p-4 rounded-xl border border-[var(--border)]">
          <div className="text-[var(--text-secondary)] text-sm mb-1 flex items-center gap-2">
        ...
        <div className="bg-[var(--bg-secondary)] border border-[var(--border)] rounded-xl overflow-hidden">
          <div className="p-4 border-b border-[var(--border)] flex justify-between items-center bg-black/20">
            ...
            <div className="flex items-center gap-2">
              <input 
                ...
                className="bg-[var(--bg-primary)] border border-[var(--border)] rounded px-2 py-1 text-sm w-32"
              />
              <button 
          ...
          <div className="p-2">
            {team.members.map((m, i) => (
              <div key={i} className="px-3 py-2 border-b border-[var(--border)] last:border-0 flex justify-between items-center hover:bg-[var(--bg-tertiary)] rounded-md transition-colors">
    ...
    <div className="space-y-6 animate-in fade-in duration-500">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-[var(--text-secondary)] text-sm mt-1">Manage SOC shifts, access, and performance tracking.</p>
        </div>
