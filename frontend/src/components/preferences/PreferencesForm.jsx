...
export const PreferencesForm = () => {
  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-300">
      <div className="flex justify-between items-center bg-[var(--bg-secondary)] p-6 rounded-xl border border-[var(--border)] shadow-sm">
        <div>
          <h2 className="text-xl font-bold text-[var(--text-primary)]">Analyst Preferences</h2>
        ...
        <button
          ...
          className="flex items-center gap-2 px-4 py-2 bg-[var(--bg-tertiary)] hover:bg-red-500/20 text-[var(--text-primary)] hover:text-red-400 border border-[var(--border)] rounded-lg text-sm transition-colors"
        >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        {/* Display Settings */}
        <div className="bg-[var(--bg-secondary)] p-6 rounded-xl border border-[var(--border)] shadow-sm space-y-6">
          <div className="flex items-center gap-3 border-b border-[var(--border)] pb-4">
            <Eye className="h-5 w-5 text-blue-500" />
            <h3 className="text-lg font-bold text-[var(--text-primary)]">Display</h3>
          </div>

          <div className="space-y-4">
            <div className="flex justify-between items-center">
              <label className="text-sm font-medium text-[var(--text-secondary)]">Theme</label>
              <div className="flex bg-[var(--bg-primary)] border border-[var(--border)] rounded-lg p-1">
                <button
                  onClick={() => handleInputChange('theme', 'light')}
                  className={`p-1.5 rounded-md flex items-center gap-2 text-sm ${store.theme === 'light' ? 'bg-blue-500 text-white' : 'text-[var(--text-secondary)] hover:text-[var(--text-primary)]'}`}
                >
                  <Sun className="h-4 w-4" /> Light
                </button>
                <button
                  onClick={() => handleInputChange('theme', 'dark')}
                  className={`p-1.5 rounded-md flex items-center gap-2 text-sm ${store.theme === 'dark' ? 'bg-blue-500 text-white' : 'text-[var(--text-secondary)] hover:text-[var(--text-primary)]'}`}
                >
            ...
            <div className="flex justify-between items-center">
              ...
              <select
                ...
                className="bg-[var(--bg-primary)] border border-[var(--border)] text-[var(--text-primary)] text-sm rounded-lg px-3 py-2 outline-none focus:border-blue-500"
              >
          ...
          <div className="space-y-4">
            ...
            <div className="flex justify-between items-center">
              ...
              <select
                ...
                className="bg-[var(--bg-primary)] border border-[var(--border)] text-[var(--text-primary)] text-sm rounded-lg px-3 py-2 outline-none focus:border-blue-500 disabled:opacity-50"
              >
        ...
        <div className="bg-[var(--bg-secondary)] p-6 rounded-xl border border-[var(--border)] shadow-sm space-y-6">
          <div className="flex items-center gap-3 border-b border-[var(--border)] pb-4">
            ...
            <h3 className="text-lg font-bold text-[var(--text-primary)]">Dashboard & Workflow</h3>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="flex justify-between items-center">
              ...
              <select
                ...
                className="bg-[var(--bg-primary)] border border-[var(--border)] text-[var(--text-primary)] text-sm rounded-lg px-3 py-2 outline-none focus:border-purple-500"
              >
            ...
            <div className="pt-4 border-t border-[var(--border)]/50 flex justify-between items-center">
              ...
              <input
                ...
                className="bg-[var(--bg-primary)] border border-[var(--border)] text-[var(--text-primary)] text-sm rounded-lg px-3 py-2 outline-none focus:border-purple-500 w-1/2"
              />
            </div>
        ...
        <div className="bg-[var(--bg-secondary)] p-6 rounded-xl border border-[var(--border)] shadow-sm space-y-6">
          <div className="flex items-center gap-3 border-b border-[var(--border)] pb-4">
            ...
            <h3 className="text-lg font-bold text-[var(--text-primary)]">Alert Table Columns</h3>
          </div>
            ...
            {Object.entries(store.alertColumns).map(([col, isVisible]) => (
              <label key={col} className="flex items-center gap-3 cursor-pointer">
                <div className="relative flex items-center">
                  ...
                  />
                  <div className="w-5 h-5 border-2 border-[var(--text-secondary)] rounded flex items-center justify-center peer-checked:bg-green-500 peer-checked:border-green-500 peer-disabled:opacity-50">
                    <svg
                ...
                <span
                  className={`text-sm ${isVisible ? 'text-[var(--text-primary)]' : 'text-[var(--text-secondary)]'}`}
                >
