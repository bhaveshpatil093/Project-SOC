...
const Banner = ({ alert, onDismiss }) => {
  ...
  return (
    <div className={`pointer-events-auto flex items-center justify-between w-full max-w-2xl mx-auto shadow-2xl rounded-xl p-4 border ${
      ...
      <div className="flex items-center gap-4 flex-1 overflow-hidden">
        <div className={`p-2 rounded-full shrink-0 ${isCritical ? "bg-red-500/20 text-red-500 animate-pulse" : "bg-orange-500/20 text-orange-500"}`}>
