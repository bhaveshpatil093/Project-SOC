      ...
      <div className="flex items-center gap-4 flex-1 overflow-hidden">
        ...
        <div className="flex flex-col truncate">
          <div className="flex items-center gap-2">
            ...
            <span className="text-[var(--text\_secondary)] text-xs">—</span>
            <span className="text-[var(--text\_primary)] font-medium text-sm truncate">
              {alert.host_id || 'Unknown Host'}
            </span>
          </div>
          <div className="text-[var(--text\_secondary)] text-xs mt-1 truncate font-mono">
            Score:{' '}
      ...
      <div className="flex items-center gap-3 shrink-0 ml-4">
        <button
          ...
          className={`px-3 py-1.5 text-xs font-bold rounded-lg transition-colors ${
            isCritical
              ? 'bg-red-600 hover:bg-red-500 text-[var(--text\_primary)]'
              : 'bg-orange-600 hover:bg-orange-500 text-[var(--text\_primary)]'
          }`}
        >
          View Alert
        </button>
        <button
          ...
          className="p-1.5 hover:bg-white/10 rounded-lg text-[var(--text\_secondary)] hover:text-[var(--text\_primary)] transition-colors"
          title="Dismiss"
        >
          <X className="h-4 w-4" />
        </button>
