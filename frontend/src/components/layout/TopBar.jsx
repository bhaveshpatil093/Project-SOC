    ...
    <header className="h-16 bg-[var(--bg-primary)]/80 backdrop-blur-xl border-b border-[var(--border)]/60 flex items-center justify-between px-4 sm:px-6 sticky top-0 z-30 shadow-sm">
      <div className="flex items-center gap-3">
        ...
        <button
          ...
          className="hidden sm:block lg:hidden p-2 rounded-lg text-[var(--text-secondary)] hover:text-[var(--text-primary)] hover:bg-[var(--bg-secondary)] transition-colors"
        >
      ...
      <div className="flex items-center gap-6">
        <div className="hidden md:flex items-center gap-2 text-[var(--text-secondary)] text-sm font-mono bg-[var(--bg-primary)]/50 px-3 py-1.5 rounded-lg border border-[var(--border)]">
          <Clock className="h-4 w-4 text-blue-500" />
          {time.toLocaleTimeString()}
        </div>

        {lastBackup && (
          <div className="hidden lg:flex items-center gap-2 text-[var(--text-secondary)] text-sm font-mono bg-[var(--bg-primary)]/50 px-3 py-1.5 rounded-lg border border-[var(--border)]" title="Last successful backup">
