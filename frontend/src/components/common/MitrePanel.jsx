...
export const MitrePanel = React.memo(({ tactics = [], techniques = [] }) => {
  if ((!tactics || tactics.length === 0) && (!techniques || techniques.length === 0)) {
    return (
      <div className="bg-[var(--bg-secondary)] border border-[var(--border)] rounded-xl p-6 text-center text-[var(--text-secondary)]">
  ...
  return (
    <div className="bg-[var(--bg-secondary)] border border-[var(--border)] rounded-xl p-5 shadow-lg">
          ...
          <div className="flex flex-wrap gap-2">
            {tactics.map((tactic, idx) => {
              ...
              return (
                <span
                  key={idx}
                  className="px-2.5 py-1 rounded-md text-xs font-bold text-[var(--text-primary)] shadow-sm border border-black/20"
          ...
          <div className="flex flex-wrap gap-2">
            {techniques.map((tech, idx) => (
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="px-2 py-1 bg-[var(--bg-primary)] hover:bg-[var(--bg-tertiary)] border border-[var(--border)] rounded text-xs font-mono text-blue-400 hover:text-blue-300 transition-colors"
