...
export function SkeletonCard({ lines = 3, className = "" }) {
  return (
    <div className={`p-4 bg-[var(--bg_secondary)] rounded-xl border border-[var(--border)] animate-pulse ${className}`}>
...
export function SkeletonTable({ rows = 5, cols = 6, className = "" }) {
  return (
    <div className={`w-full bg-[var(--bg_secondary)] rounded-xl border border-[var(--border)] animate-pulse overflow-hidden ${className}`}>
      {/* Header */}
...
export function SkeletonGauge({ className = "" }) {
  return (
    <div className={`flex flex-col items-center justify-center p-6 bg-[var(--bg_secondary)] rounded-xl border border-[var(--border)] animate-pulse ${className}`}>
