  ...
  return (
    <div className="max-w-7xl mx-auto space-y-8 animate-in fade-in duration-300">
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-3xl font-bold text-[var(--text_primary)] tracking-tight">
            System Settings
          </h1>
      ...
      {activeTab === 'health' && (
        <>
          ...
          <div className="bg-[var(--bg_secondary)] rounded-xl border border-[var(--border)] p-6 shadow-lg">
            <div className="flex justify-between items-center mb-6">
              <div className="flex gap-4">
                <button
                  ...
                  className={`px-4 py-2 font-bold rounded-md transition-colors ${activeTab === 'general' ? 'bg-blue-600 text-white' : 'bg-[var(--bg_secondary)] text-[var(--text_secondary)] hover:text-[var(--text_primary)]'}`}
                >
                  General
                </button>
                <button
                  onClick={() => setActiveTab('advanced')}
                  className={`px-4 py-2 font-bold rounded-md transition-colors ${activeTab === 'advanced' ? 'bg-blue-600 text-white' : 'bg-[var(--bg_secondary)] text-[var(--text_secondary)] hover:text-[var(--text_primary)]'}`}
                >
                  Advanced
                </button>
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              {deepHealth?.components?.map((comp) => (
                <div
                  key={comp.name}
                  className="bg-[var(--bg_primary)] border border-[var(--border)] rounded-lg p-4 flex flex-col justify-between"
                >
                  <div className="flex justify-between items-start mb-3">
                    <h3 className="text-sm font-bold text-[var(--text_primary)] capitalize">
                      {comp.name.replace('_', ' ')}
                    </h3>
                    <span
                  ...
                  <div className="space-y-1 mt-auto">
                    <p className="text-xs text-[var(--text_secondary)] flex justify-between">
                      <span>Latency</span>
                      <span className="font-mono text-[var(--text_secondary)]">
                    ...
                    {Object.entries(comp.details || {})
                      ...
                      .map(([k, v]) => (
                        <p
                          key={k}
                          className="text-xs text-[var(--text_secondary)] flex justify-between"
                        >
                          <span className="capitalize">{k.replace(/_/g, ' ')}</span>
                          <span
                            className="font-mono text-[var(--text_secondary)] truncate max-w-[120px]"
                            title={String(v)}
                          >
                            {String(v)}
                          </span>
          ...
          <div className="bg-[var(--bg_secondary)] rounded-xl border border-[var(--border)] overflow-hidden shadow-lg p-6">
            <div className="flex justify-between items-center mb-6">
              ...
              {slmLoading || reloadModelMutation.isPending ? (
                ...
                <span
                  className={`text-xs font-bold px-2 py-1 rounded-full border ${slmModelInfo?.is_finetuned ? 'bg-purple-500/10 text-purple-400 border-purple-500/30' : 'bg-[var(--bg_tertiary)]/50 text-[var(--text_secondary)] border-[var(--border)]'}`}
                >
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
              <div className="bg-[var(--bg_primary)] rounded-lg p-4 border border-[var(--border)]">
                <h4 className="text-xs text-[var(--text_secondary)] uppercase font-semibold mb-1">
                  Current Model
                </h4>
                <p
                  className="text-sm text-[var(--text_primary)] truncate"
              ...
              <div className="bg-[var(--bg_primary)] rounded-lg p-4 border border-[var(--border)]">
                ...
                <p className="text-sm text-[var(--text_primary)] uppercase font-mono">
              ...
              <div className="bg-[var(--bg_primary)] rounded-lg p-4 border border-[var(--border)]">
                ...
                <p className="text-sm text-[var(--text_primary)]">
          ...
          <div className="bg-[var(--bg_secondary)] rounded-xl border border-[var(--border)] overflow-hidden shadow-lg p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
              <div className="bg-[var(--bg_primary)] rounded-lg p-4 border border-[var(--border)]">
                ...
                <p className="text-lg text-[var(--text_primary)] font-mono font-bold text-purple-400">
              ...
              <div className="bg-[var(--bg_primary)] rounded-lg p-4 border border-[var(--border)]">
                ...
                <p className="text-xs text-[var(--text_primary)] font-mono break-all">
          ...
          <div className="bg-[var(--bg_secondary)] rounded-xl border border-[var(--border)] overflow-hidden shadow-lg p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
              <div className="bg-[var(--bg_primary)] border border-[var(--border)] rounded-xl p-5 flex flex-col items-center justify-center text-center">
                ...
                <div className="text-3xl font-black text-[var(--text_primary)]">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              <table className="w-full text-left whitespace-nowrap">
                <tbody className="divide-y divide-[var(--border)]/30 text-sm">
                  <tr className="hover:bg-[var(--bg_tertiary)]/30">
                    <td className="px-6 py-4 font-medium text-[var(--text_secondary)]">
                      Window Size (minutes)
                    </td>
            ...
            <div className="bg-[var(--bg_secondary)] rounded-xl border border-[var(--border)] p-6 flex flex-col justify-center items-center text-center shadow-lg lg:col-span-1 border-t-4 border-t-blue-500">
              ...
              <div className="flex flex-wrap justify-center gap-2 mt-auto">
                <span className="text-[10px] uppercase tracking-wider font-bold bg-[var(--bg_primary)] border border-[var(--border)] text-[var(--text_secondary)] px-2 py-1 rounded">
                  Python 3.11
                </span>
                <span className="text-[10px] uppercase tracking-wider font-bold bg-[var(--bg_primary)] border border-[var(--border)] text-[var(--text_secondary)] px-2 py-1 rounded">
                  FastAPI
          ...
          <div>
            <h2 className="text-xl font-bold text-[var(--text_primary)] mb-6 mt-4">
