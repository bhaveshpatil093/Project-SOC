...
export function exportAlertsToCSV(alerts, filename = "soc_alerts.csv") {
    const headers = ["ID", "Timestamp", "Host", "User", "Log Type", "Threat Score", "Threat Level", "MITRE Tactic", "Triggered Rules", "Status"];
...
export function exportIncidentsToCSV(incidents, filename = "soc_incidents.csv") {
    const headers = ["Incident ID", "Entity", "Started At", "Duration (min)", "Alert Count", "Max Threat", "Stage", "Multi-Stage", "Status"];
