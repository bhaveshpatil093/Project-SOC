...
for i, line in enumerate(lines):
    if line.startswith("async def chat_endpoint("):
        in_chat_endpoint = True
    
    if in_chat_endpoint and "return ChatResponse(" in line:
...
{spaces})
{spaces}await slm_analytics_instance.track_query(es, conv.conversation_id, req.message, "chat", req.alert_id, metrics)
"""
