...
class ESConnectionError(SOCBaseException):
    def __init__(self, message: str = "Failed to connect to Elasticsearch", details: dict[str, Any] | None = None):
        super().__init__(message, "ES_CONNECTION_ERROR", details)

class ModelNotLoadedError(SOCBaseException):
    def __init__(self, message: str = "Required ML model is not loaded", details: dict[str, Any] | None = None):
        super().__init__(message, "MODEL_NOT_LOADED", details)

class SLMNotReadyError(SOCBaseException):
    def __init__(self, message: str = "SLM engine is not ready", details: dict[str, Any] | None = None):
...
class InvalidFeedbackError(SOCBaseException):
    def __init__(self, message: str = "Invalid feedback provided", details: dict[str, Any] | None = None):
...
class InferenceTooSlowError(SOCBaseException):
    def __init__(self, message: str = "Inference took too long", details: dict[str, Any] | None = None):
